#' @title Fit Latent Class Growth Analysis (LCGA) models to refine covariance structure.
#'
#' @description Refine the residual variance structure by fitting a series of LCGA models
...
#' @return A list of `mplusObject` including results for the fitted LCGA models.

#' @details The `fitLCGA` function automates the process of fitting LCGA models, iterating through 3 varying residual variance specifications:
#' \itemize{
